...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { favorited: @cat.favorited, image_url: @cat.image_url, is_adopted: @cat.is_adopted, name: @cat.name } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { favorited: @cat.favorited, image_url: @cat.image_url, is_adopted: @cat.is_adopted, name: @cat.name } }
